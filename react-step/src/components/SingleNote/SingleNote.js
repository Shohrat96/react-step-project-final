...
class SingleNote extends Component {
    ...
    render() {
        ...
        if (redirectToHome===true){
            ...
            return (
                <>
                    <Redirect to="/Archive"></Redirect>
                    <Archive/>
                </>
            )
        }
        return (
            // {this.props.allData[this.props.noteID].text}
            <div className='note' id={this.state.clickedNote.id}>
                ...
                </div>
                {
                    ...
                    header={'This is to confirm deleting the note item'} closeButton={true} text={'Are you sure you want to delete it from the note items list?'} actions={[<Button classNames={'button delete-approve'} textContent={'OK'} background={'#b3382c'} />, <Button textContent={'CANCEL'} classNames={'button button-cancel'} background={'#b3382c'}/>]}
                    /> : null
                ...
                <div className="buttons">
                    <Link to={{
                        ...
                        <button onClick={this.editNote} className='edit-button'>EDIT</button>
                    </Link>
